...
\begin{tikzpicture}[node distance=2.5cm]
  ...
  \draw (a1) edge[bend right] node{\colorbox{black}{\textcolor{white}{\textbf{2}}} Gossip of Transaction} (a2);
  \draw (a1) edge[bend left] node{\colorbox{black}{\textcolor{white}{\textbf{2}}} Gossip of Transaction} (a3);
  ...
  \draw (b1) edge[bend left] node{\colorbox{black}{\textcolor{white}{\textbf{3}}} Gossip of Confirmed Block} (bankB);
